...
import upei.deck.InfectDeck;
import upei.deck.PlayerDeck;
import upei.variables.Disease;
import upei.variables.Piece;
import upei.variables.Variables;

/***
 * This is an attempt to construct pandemic Board game edition.*
 ***/
...
public class GameBoard {
    ...
    public void infectEpidemic()
    {
        ...
        //decrease the available cubes of this colour
        removeCube(toInfect.getColour());
        removeCube(toInfect.getColour());
        removeCube(toInfect.getColour());
    ...
    {
        System.out.println("Setting initial station in Algeria");
        for (int i = 0 ; i < cities.size() ; i ++)
        {
            if (cities.get(i).equals(Variables.algiers)) {
